...
const translations: Record<string, Record<Language, string>> = {
  ...
  'about.originP1': { en: 'During 10 months of fieldwork across Thailand, we observed that many standard research techniques yielded surface-level insights. Participants would often provide polite, positive feedback even when they had real concerns. Critical feedback was rare, and honest opinions about sensitive topics were difficult to surface.', th: 'ในระหว่างการทำงานภาคสนาม 10 เดือนทั่วประเทศไทย เราสังเกตว่าเทคนิคการวิจัยมาตรฐานจำนวนมากให้ข้อมูลเชิงลึกในระดับผิวเผิน ผู้เข้าร่วมมักจะให้ข้อเสนอแนะที่สุภาพและเป็นบวกแม้ว่าพวกเขาจะมีข้อกังวลจริงๆ ความคิดเห็นเชิงวิพากษ์หายาก และความคิดเห็นที่ซื่อสัตย์เกี่ยวกับหัวข้อที่ละเอียดอ่อนนั้นยากที่จะปรากฏ' },
  'about.originP2': { en: 'This toolkit records how HCD methods were adapted to Thailand\'s social norms; however, the research team hopes this toolkit can be a guide for anyone conducting co-design research in the Global South, or culturally similar contexts.', th: 'ชุดเครื่องมือนี้อธิบายวิธีการปรับวิธีการ HCD ให้เหมาะกับบรรทัดฐานทางสังคมของประเทศไทย อย่างไรก็ตาม ทีมวิจัยหวังว่าชุดเครื่องมือนี้จะเป็นแนวทางสำหรับทุกคนที่ทำการวิจัยการออกแบบร่วมกันใน Global South หรือบริบททางวัฒนธรรมที่คล้ายคลึงกัน' },
  ...
  'facilitation.goal': { en: 'Your job is to give people enough structure to guide them, without pushing them in a certain direction.', th: 'เป้าหมายของคุณในฐานะผู้ดำเนินการคือให้โครงสร้างที่เพียงพอเพื่อแนะนำผู้เข้าร่วมโดยไม่ชี้นำหรือทำให้เกิดอคติ' },
  'facilitation.tip1': { en: 'Keep observers to a minimum. They make people hold back and worry more about hierarchy.', th: 'จำกัดผู้สังเกตการณ์ พวกเขาทำให้ผู้เข้าร่วมลังเลที่จะแบ่งปันและไวต่อลำดับชั้น' },
  'facilitation.tip2': { en: 'Split groups by seniority so people feel more comfortable speaking up.', th: 'แยกกลุ่มตามอาวุโสเพื่อการแสดงออกที่เปิดกว้าง' },
  'facilitation.tip3': { en: 'Keep it simple—let people figure things out on their own. Tell them what they\'re trying to do, not how the system works.', th: 'ให้บริบทน้อยที่สุด และรอให้ผู้ใช้เข้าใจระบบด้วยตนเอง อธิบายเป้าหมาย ไม่ใช่การทำงานของระบบ' },
  'facilitation.tip4': { en: 'Don\'t assume—ask people why they feel that way. Skip leading questions that push them toward certain answers.', th: 'อย่าสร้างสมมติฐาน—ถามผู้ใช้ให้อธิบายว่าทำไมถึงรู้สึกแบบนั้น หลีกเลี่ยงคำถามชี้นำที่ทำให้เกิดอคติในการตอบ' },
  'facilitation.tip6': { en: 'Get someone else to run the session, not the designer. Tell people you didn\'t make the designs so they\'ll feel more comfortable critiquing.', th: 'ให้คนอื่นที่ไม่ใช่ผู้ออกแบบเป็นผู้ดำเนินการเซสชัน บอกผู้เข้าร่วมว่าคุณไม่ได้สร้างการออกแบบเพื่อให้วิจารณ์ได้โดยลังเลน้อยลงที่จะทำให้คุณไม่พอใจ' },
  'facilitation.tip7': { en: 'After writing, ask quieter people to share. Let them know their ideas matter.', th: 'หลังกิจกรรมการเขียน เชิญสมาชิกที่เงียบกว่าให้แบ่งปันความคิดเห็น ยืนยันการมีส่วนร่วมเพื่อสร้างความมั่นใจ' },
  'facilitation.tip8': { en: 'People might keep talking until everyone agrees, even if time\'s up. Plan for things to run long.', th: 'ผู้เข้าร่วมอาจต้องการอภิปรายต่อไปจนกว่าจะบรรลุฉันทามติ แม้เวลาที่กำหนดไว้จะหมดแล้ว วางแผนงบประมาณให้การอภิปรายใช้เวลานานเกินกำหนดและเวิร์กช็อปใช้เวลานานกว่าที่คาดไว้' },
  'facilitation.tip9': { en: 'Do research in person when you can, especially with people who aren\'t super tech-savvy (like folks in rural areas or older users).', th: 'ดำเนินการวิจัยแบบพบหน้ากันเมื่อเป็นไปได้ โดยเฉพาะเมื่อทำงานกับผู้ใช้ที่มีทักษะดิจิทัลต่ำ (เช่น ผู้ใช้ในชนบท ผู้ใช้สูงอายุ เป็นต้น)' },
  'facilitation.tip10': { en: 'People give better feedback on rough stuff. Ask for thoughts on sketches and wireframes instead of polished designs when you can.', th: 'ผู้คนมีแนวโน้มที่จะให้คำวิจารณ์ที่ซื่อสัตย์ต่องานที่มีความละเอียดต่ำ เมื่อเป็นไปได้ ขอความคิดเห็นเกี่ยวกับภาพร่าง ไวร์เฟรม และร่างหยาบแทนการออกแบบที่สมบูรณ์' },
  'facilitation.tip11': { en: 'Save the critique for the end. People are quieter at first, but they\'ll open up more once they get comfortable.', th: 'วางงานประเมินและวิจารณ์ไว้ท้ายเซสชัน ผู้เข้าร่วมจะสงวนตัวในช่วงแรก แต่การโต้ตอบระหว่างสมาชิกจะเพิ่มขึ้นเมื่อมีความคุ้นเคย' },
  'facilitation.tip12': { en: 'Use something random like a spin-the-wheel game to decide who talks next. It takes the power out of your hands and makes things more equal.', th: 'ใช้เอฟเฟกต์แบบสุ่มเช่นเกม "หมุนวงล้อ" เพื่อมอบอำนาจในการให้โอกาสพูดให้กับวัตถุที่เป็นกลางแทนผู้ดำเนินการ นี่ช่วยกระจายอำนาจของพลวัต' },
  'facilitation.tip13': { en: 'In places with strong hierarchy, sit people in a circle instead of rows. It breaks down the usual power structure and helps everyone participate more equally.', th: 'ในบริบทที่มีลำดับชั้น จัดผู้เข้าร่วมเป็นวงกลมเพื่อทำลายโครงสร้างการประชุมแบบดั้งเดิม การปรับโครงสร้างทางกายภาพนี้สามารถทำให้ความสัมพันธ์ทางอำนาจเท่าเทียมกันและอำนวยความสะดวกในการตัดสินใจร่วมกันที่แท้จริงมากขึ้น' },
  ...
  'facilitation.challenge1Solution': { en: 'Try Write-then-Speak methods, or use anonymous Dot Voting to pick between ideas.', th: 'เปลี่ยนไปใช้วิธีการเขียนก่อนพูด หรือการลงคะแนนด้วยจุดแบบไม่ระบุชื่อเพื่อเลือกระหว่างไอเดีย' },
  'facilitation.challenge2': { en: 'People won\'t sketch', th: 'ผู้คนไม่ยอมวาดภาพ' },
  'facilitation.challenge2Solution': { en: 'Give them paper pieces that are already made, or worksheets with some structure (like phone outlines with labels showing which step they should draw).', th: 'ใช้ส่วนประกอบกระดาษที่สร้างไว้ล่วงหน้า หรือใช้เวิร์กชีตที่มีโครงสร้างบางอย่าง (เช่น รูปทรงโทรศัพท์ที่มีป้ายบอกขั้นตอนของกระบวนการที่ควรวาด)' },
  ...
  'facilitation.challenge3Solution': { en: 'Get observers out. Have any designers or builders leave the room. Ask people to write their thoughts on worksheets or sticky notes, then pair them up to discuss.', th: 'ลบผู้สังเกตการณ์ ให้ผู้ออกแบบหรือผู้สร้างระบบออก ขอให้ผู้คนเขียนความคิดของพวกเขาบนเวิร์กชีตหรือโน้ตติด และจับคู่ผู้คนเพื่ออภิปราย' },
  'facilitation.challenge4': { en: 'People are just echoing others\' thoughts', th: 'ผู้คนเพียงแค่ทำซ้ำความคิดของผู้อื่น' },
  'facilitation.challenge4Solution': { en: 'Ask more specific questions. Instead of "What problems do you have with this system?", try "What was the most frustrating moment?" or "Why did you hesitate before pressing that button?"', th: 'ถามคำถามติดตามที่เฉพาะเจาะจงมากขึ้น แทนที่จะถามว่า "คุณมีปัญหาอะไรกับระบบนี้?" ถามว่า "ช่วงเวลาที่น่าหงุดหงิดที่สุดในกระบวนการนี้คืออะไร?" หรือ "ทำไมคุณถึงลังเลก่อนกดปุ่มนั้น?"' },
  ...
  // Method Detail
  'methodDetail.backToHome': { en: 'Back to Methods', th: 'กลับไปที่วิธีการ' },
